...
3 SVM Models - One for each K

10 seed values

Squared Error: MSE(K1) + MSE(k2) + MSE(K3)

### Box Sizes Comparison (No Shrinking)
<img src="../../results/k_centered_results/k_centered_box_sizes_comparison.png" width="800">

### Shrink Rates Comparison (K ∈ [K/2, K×2])
<img src="../../results/k_centered_results/k_centered_shrink_rates_comparison.png" width="800">
...
#### Uniform Sampling - Training Dataset
<img src="../../pipeline_results/chemical_plots/uniform_sampling_k_distribution.png" width="1000">
<img src="../../pipeline_results/chemical_plots/uniform_sampling_chemistry_distribution.png" width="1000">

#### Uniform Sampling - Test Dataset
<img src="../../pipeline_results/chemical_plots/test_dataset_k_distribution.png" width="1000">
<img src="../../pipeline_results/chemical_plots/test_dataset_chemistry_distribution.png" width="1000">

#### Log-Uniform Sampling
<img src="../../pipeline_results/chemical_plots/log-uniform_sampling_k_distribution.png" width="1000">
<img src="../../pipeline_results/chemical_plots/log-uniform_sampling_chemistry_distribution.png" width="1000">

#### Uniform Latin Hypercube Sampling
<img src="../../pipeline_results/chemical_plots/uniform_latin_hypercube_sampling_k_distribution.png" width="1000">
<img src="../../pipeline_results/chemical_plots/uniform_latin_hypercube_sampling_chemistry_distribution.png" width="1000">

#### Log-Uniform Latin Hypercube Sampling
<img src="../../pipeline_results/chemical_plots/log-uniform_latin_hypercube_sampling_k_distribution.png" width="1000">
<img src="../../pipeline_results/chemical_plots/log-uniform_latin_hypercube_sampling_chemistry_distribution.png" width="1000">

#### Morris Method Sampling
<img src="../../pipeline_results/chemical_plots/morris_method_sampling_(continuous)_k_distribution.png" width="1000">
<img src="../../pipeline_results/chemical_plots/morris_method_sampling_(continuous)_chemistry_distribution.png" width="1000">
...
<img src="../../pipeline_results/chemical_plots/window_sampling/window_batch_1_(4000_samples)_-_uniform_sampling_k_distribution.png" width="1000">
<img src="../../pipeline_results/chemical_plots/window_sampling/window_batch_1_(4000_samples)_-_uniform_sampling_chemistry_distribution.png" width="1000">

#### Batch 2 - K ∈ [K_true/1.15, K_true×1.15]
<img src="../../pipeline_results/chemical_plots/window_sampling/window_batch_2_(1000_samples)_-_uniform_sampling_k_distribution.png" width="1000">
<img src="../../pipeline_results/chemical_plots/window_sampling/window_batch_2_(1000_samples)_-_uniform_sampling_chemistry_distribution.png" width="1000">

#### Batch 3 - K ∈ [K_true/1.15, K_true×1.15]
<img src="../../pipeline_results/chemical_plots/window_sampling/window_batch_3_(2500_samples)_-_uniform_sampling_k_distribution.png" width="1000">
<img src="../../pipeline_results/chemical_plots/window_sampling/window_batch_3_(2500_samples)_-_uniform_sampling_chemistry_distribution.png" width="1000">

#### Batch 4 - K ∈ [K_true/1.005, K_true×1.005]
<img src="../../pipeline_results/chemical_plots/window_sampling/window_batch_4_(2000_samples)_-_uniform_sampling_k_distribution.png" width="1000">
<img src="../../pipeline_results/chemical_plots/window_sampling/window_batch_4_(2000_samples)_-_uniform_sampling_chemistry_distribution.png" width="1000">

#### Batch 5 - K ∈ [K_true/1.0005, K_true×1.0005]
<img src="../../pipeline_results/chemical_plots/window_sampling/window_batch_5_(1500_samples)_-_uniform_sampling_k_distribution.png" width="1000">
<img src="../../pipeline_results/chemical_plots/window_sampling/window_batch_5_(1500_samples)_-_uniform_sampling_chemistry_distribution.png" width="1000">

#### Batch 6 - K ∈ [K_true/1.00005, K_true×1.00005]
<img src="../../pipeline_results/chemical_plots/window_sampling/window_batch_6_(2000_samples)_-_uniform_sampling_k_distribution.png" width="1000">
<img src="../../pipeline_results/chemical_plots/window_sampling/window_batch_6_(2000_samples)_-_uniform_sampling_chemistry_distribution.png" width="1000">
...
### Full MSE Comparison
<img src="../../pipeline_results/plots/sample_efficiency_comparison_20251020_194107.png" width="800">

### Error Per Output - Uniform Sampling
<img src="../../pipeline_results/plots/sample_efficiency_uniform_per_output_20251020_194109.png" width="1000">
...
<img src="../../pipeline_results/plots/perturbation_intervals_20251020_193805.png" width="1200">
