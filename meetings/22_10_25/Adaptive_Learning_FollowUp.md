...
**Data Files:**
- Full results CSV: [perturbation_table_20251020_184532.csv](../../pipeline_results/plots/perturbation_table_20251020_184532.csv)

### Visualization Plots

The perturbation analysis generates three types of visualizations:

1. **Prediction Interval Plots** - Shows how prediction intervals narrow with increased training data
2. **Containment Summary** - Bar chart showing containment percentage for each K across different N values
3. **Per-Output Analysis** - Detailed breakdown of each rate coefficient's performance
