...
def main(BATCH_FILES: str):
    ...
    max_total_samples = 500*4 + 100  # Fixed total budget
    num_seeds = 15
    ...
    for samples_per_iteration in iteration_configs.keys():
        ...
        for shrink_rate in iteration_configs[samples_per_iteration]:
            ...
            pipeline = AdaptiveBatchSamplingPipeline(
                ...
                use_model_prediction=config_use_model_prediction,  # Use true K values for window centering
    ...
    summary_file = Path("pipeline_results/sample_efficiency_summary" )
...
if __name__ == "__main__":
    ...
    train_datasets = [
        ...
        'data/SampleEfficiency/O2_simple_log.txt',
    ...
    labels = {
        ...
        'data/SampleEfficiency/O2_simple_log.txt':'NN_batch_Log-Uniform',
    ...
    BATCH_FILES = [
        ...
        {
            'path': train_datasets[0],
            'label': labels[train_datasets[0]],
            'k_range': 'K ∈ [K_true/2, K_true×2]'
        },
    ]
    results = main(BATCH_FILES)

    print("\n✅ Experiment completed.")

    print(train_datasets[0])
    print(labels[train_datasets[0]])
