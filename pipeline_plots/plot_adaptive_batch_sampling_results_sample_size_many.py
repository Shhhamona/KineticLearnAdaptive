...
def plot_adaptive_batch_sampling_results(result_files, output_dir='pipeline_results/plots', labels=None):
    ...
    fig.suptitle(f'Neural Network Training - Adaptive Batch Sampling\n'
                 f'Uniform Sampling with Varying K Range (Training Data: {dataset_info})', 
...
def main():
    ...
    result_files = [
        'pipeline_results/sample_efficiency_300per_iter_shrink1.0_20251124_163023.json',
        'pipeline_results/sample_efficiency_800per_iter_shrink0.4_20251122_000540.json',
        'pipeline_results/sample_efficiency_800per_iter_shrink0.2_20251124_161040.json',
        'pipeline_results/sample_efficiency_500per_iter_shrink0.4_20251126_001956.json'
    ]
    
    labels = [
        'Uniform Batching',
        'Adaptive Sampling (60% shrink/iter)',
        'Adaptive Sampling (80% shrink/iter)',
