...
def main():
    ...
    result_files = [
        'pipeline_results/adaptive_batch_sampling_w1.0_s1_e50_20251112_162226.json',
        'pipeline_results/sample_efficiency_800per_iter_shrink0.4_20251112_155054.json'
    ]
