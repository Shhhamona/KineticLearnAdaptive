...
def plot_adaptive_batch_sampling_results(result_files, output_dir='pipeline_results/plots', labels=None):
    ...
    # Create main title
    fig.suptitle(f'Neural Network Training - Sampling Methods Comparison\n', 
...
def main():
    ...
    result_files = [
        'pipeline_results/sample_efficiency_400per_iter_shrink1_20251208_223127.json',
        'pipeline_results/sample_efficiency_400per_iter_shrink1_20251208_220647.json',
        'pipeline_results/sample_efficiency_400per_iter_shrink1_20251208_215314.json',
        'pipeline_results/sample_efficiency_400per_iter_shrink1_20251208_213417.json',
        'pipeline_results/sample_efficiency_400per_iter_shrink1_20251208_204431.json',
        'pipeline_results/sample_efficiency_400per_iter_shrink1_20251208_211820.json'
    ]
