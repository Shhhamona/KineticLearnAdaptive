...
def plot_adaptive_batch_sampling_results(
    ...
    fig1.suptitle(
        ...
        "Uniform Sampling with Varying K Range Shifted - [K'/3, K'×3]",
        fontsize=15,
        fontweight="bold",
        y=0.98,
    )
...
def main():
    ...
    result_files = [
        "pipeline_results/sample_efficiency_400per_iter_shrink1.0_20251208_154636.json",
        "pipeline_results/sample_efficiency_800per_iter_shrink0.4_20251210_082739.json",
    ]

    labels = [
        "Uniform Batching - Shifted ",
        "Adaptive Sampling - Shifted (800 samples/iter, 60% shrink/iter)",
